...
public enum SelectorType {
    ...
    boolean select(final OreConfigFilter config, @Nullable final ResourceLocation biome, final EnumSet<BiomeManager.BiomeType> biomeTypes, final BiomeDictionary.Type[] biomeDictTypes) {
    ...
    private interface BiomePredicate {
        boolean test(final OreConfigFilter config, @Nullable final ResourceLocation biome, final EnumSet<BiomeManager.BiomeType> biomeTypes, final BiomeDictionary.Type[] biomeDictTypes);
    }
}
